...
public class Biblioteka {
	...
	public static void main(String[] args) {
		...
		b.tab[3] = new Pracownik("Nowak", "23472345", "sprz¹tacz", 1500, 8);
		...
		for(int i = 0; i< b.n; i++)		//wyswietlanie pracownikow
		{
			...
			{
				System.out.printf("%s", b.tab[i].toString());
				( (Pracownik)b.tab[i] ).wyœwietlLiczbêNadgodzin();
			}
				
		}
		
		((Czytelnik)b.tab[5] ).Wypo¿ycz(new Ksi¹¿ka());
		((Czytelnik)b.tab[5] ).Wypo¿ycz(new Ksi¹¿ka(96045, 2, true));
		((Czytelnik)b.tab[5] ).Wypo¿ycz(new Ksi¹¿ka(76380, 1.5, false));
		((Czytelnik)b.tab[6] ).Wypo¿ycz(new Ksi¹¿ka(23505, 3, false));
		((Czytelnik)b.tab[6] ).Wypo¿ycz(new Ksi¹¿ka(14253, 1.7, false));
		((Czytelnik)b.tab[6] ).Wypo¿ycz(new Ksi¹¿ka(26352, 2.4, true));
		((Czytelnik)b.tab[6] ).Wypo¿ycz(new Ksi¹¿ka());
		((Czytelnik)b.tab[6] ).Wypo¿ycz(new Ksi¹¿ka(50401, 1.9, false));
		...
		System.out.printf("Najwiêcej zarobi³: %s", ((Pracownik)b.tab[msce]).getStanowisko());
	}
